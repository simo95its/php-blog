	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    ...
		    $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext' aria-label='Previous'><span aria-hidden='true'>&laquo; Previous</span></a></li>";
		else
		    //$pagination.= "<span class='disabled'>« previous</span>";
		    $pagination.= "<li><span aria-hidden='true' class='disabled'>&laquo; Previous</span></li>";
		...
		if ($counter == $this->_page)
		    ...
		    $pagination.= "<li><span class='current' disabled='disabled'>$counter</span></li>";
		else
		...
		if ($this->_page < $counter - 1)
		    ...
		    $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext' aria-label='Next'><span aria-hidden='true'>Next &raquo;</span></a></li>";
		else
		    //$pagination.= "<span class='disabled'>next »</span>";
		    $pagination.= "<li><span aria-hidden='true' class='disabled'>Next &raquo;</span></li>";
		    $pagination.= "</ul></nav>\n";
		}
