...
--
-- Host: 127.0.0.1
-- Creato il: Lug 10, 2017 alle 21:37
...
--
-- Struttura della tabella `blog_cats`
--
...
--
-- Dump dei dati per la tabella `blog_cats`
--
...
--
-- Struttura della tabella `blog_members`
--
...
--
-- Dump dei dati per la tabella `blog_members`
--
...
INSERT INTO `blog_posts` (`postID`, `postTitle`, `postSlug`, `postDesc`, `postCont`, `postDate`) VALUES
...
--
-- Struttura della tabella `blog_post_cats`
--
...
--
-- Dump dei dati per la tabella `blog_post_cats`
--
...
--
-- Indici per le tabelle `blog_cats`
--
ALTER TABLE `blog_cats`
  ADD PRIMARY KEY (`catID`);

--
-- Indici per le tabelle `blog_members`
--
...
--
-- Indici per le tabelle `blog_post_cats`
--
...
--
-- AUTO_INCREMENT per la tabella `blog_cats`
--
ALTER TABLE `blog_cats`
  MODIFY `catID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT per la tabella `blog_members`
--
ALTER TABLE `blog_members`
...
--
-- AUTO_INCREMENT per la tabella `blog_post_cats`
--
ALTER TABLE `blog_post_cats`
